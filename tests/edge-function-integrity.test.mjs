...
assert.match(source, /baseline_intervals_seconds:\s*cleanNumberArray\(body\.baseline_intervals_seconds/);
assert.match(source, /intervention_jerk_count:\s*nonNegativeInt\(body\.intervention_jerk_count\)/);
assert.match(source, /intervention_duration_seconds:\s*nonNegativeInt\(body\.intervention_duration_seconds\)/);
